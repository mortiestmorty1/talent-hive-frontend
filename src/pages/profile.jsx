...
const EnhancedProfile = dynamic(() => import("../components/EnhancedProfile"), { ssr: false });
    ...
    <>
      {isLoaded && (
        ...
        <div className="flex flex-col items-center justify-start min-h-[80vh] gap-3">
          ...
          <h2 className="text-3xl">Welcome to TalentHive 👋 </h2>
        ...
        <div className="w-full max-w-6xl mx-auto px-4 md:px-0 mt-8">
              ...
              {isSeller ? (
                ...
                <>
                  <button
                    ...
                    className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                  >
                  ...
                  <button
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                  >
                    <span className="mr-2">💼</span>
                    My Gigs
                  </button>
                  <button
                    ...
                    className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-3 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                  >
                    <span className="mr-2">📊</span>
                    Dashboard
                  </button>
