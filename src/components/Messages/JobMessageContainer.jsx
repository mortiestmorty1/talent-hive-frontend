...
import { SEND_JOB_MESSAGE, GET_JOB_MESSAGES } from "../../utils/constants";

const JobMessageContainer = () => {
  ...
  useEffect(() => {
    const getMessages = async () => {
      try {
        setLoading(true);
        const { data } = await axios.get(`${GET_JOB_MESSAGES}?jobId=${jobId}`, {
          headers: {
...
export default JobMessageContainer;
